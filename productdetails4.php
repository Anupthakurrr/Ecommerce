...
<body>
    ...
    <div class="small-container single-products">
        <div class="row">
            <div class="col-2">
                <img src="latest first.png" width="300%" id="productImg">

                    <div class="small-img-row">
                        <div class="small-img-col">
                            <img src="pd5_side.png" width="90px" class="small-img">
                        </div>
                        <div class="small-img-col">
                            <img src="pd_5 back.png" width="90px" class="small-img">
                        </div>
                        <div class="small-img-col">
                            <img src="pd5_logo.png" width="90px" class="small-img">
                        </div>
                        <div class="small-img-col">
                            <img src="pd5_model.png" width="90px" class="small-img">
                        </div>
                    </div>
