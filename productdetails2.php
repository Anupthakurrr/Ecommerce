...
<body>
    ...
    <div class="small-container single-products">
        <div class="row">
            <div class="col-2">
                <img src="product 3.png" width="300%" id="productImg">

                    <div class="small-img-row">
                        <div class="small-img-col">
                            <img src="pd3_front.png" width="90px" class="small-img">
                        </div>
                        <div class="small-img-col">
                            <img src="pd_3 brand.png" width="90px" class="small-img">
                        </div>
                        <div class="small-img-col">
                            <img src="pd_3 full.png" width="90px" class="small-img">
                        </div>
                        <div class="small-img-col">
                            <img src="pd_3.png" width="90px" class="small-img">
                        </div>
                    </div>
