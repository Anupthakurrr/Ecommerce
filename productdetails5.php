...
<body>
    ...
    <div class="small-container single-products">
        <div class="row">
            <div class="col-2">
                <img src="latest.png" width="300%" id="productImg">
                    ...
                    <div class="small-img-row">
                        ...
                        <div class="small-img-col">
                            <img src="pd6_back.png" width="90px" class="small-img">
                        </div>
                        <div class="small-img-col">
                            <img src="pd6_brand.png" width="90px" class="small-img">
                        </div>
                        <div class="small-img-col">
                            <img src="pd6_sample.png" width="90px" class="small-img">
                        </div>
                    </div>
