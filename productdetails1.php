...
<body>
    ...
    <div class="small-container single-products">
        <div class="row">
            <div class="col-2">
                <img src="product 2.png" width="300%" id="productImg">

                    <div class="small-img-row">
                        <div class="small-img-col">
                            <img src="pd_2.png" width="90px" class="small-img">
                        </div>
                        <div class="small-img-col">
                            <img src="p2_back.png" width="90px" class="small-img">
                        </div>
                        <div class="small-img-col">
                            <img src="p2_logo.png" width="90px" class="small-img">
                        </div>
                        <div class="small-img-col">
                            <img src="pd_brand.png" width="90px" class="small-img">
                        </div>
                    </div>
