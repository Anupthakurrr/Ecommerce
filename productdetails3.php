...
<body>
    ...
    <div class="small-container single-products">
        <div class="row">
            <div class="col-2">
                <img src="product 4.png" width="300%" id="productImg">

                    <div class="small-img-row">
                        <div class="small-img-col">
                            <img src="pd_4 full.png" width="90px" class="small-img">
                        </div>
                        <div class="small-img-col">
                            <img src="pd_4 back.png" width="90px" class="small-img">
                        </div>
                        <div class="small-img-col">
                            <img src="pd4_logo .png" width="90px" class="small-img">
                        </div>
                        <div class="small-img-col">
                            <img src="pd4_brand.png" width="90px" class="small-img">
                        </div>
                    </div>
