...
<body>
    ...
    <div class="small-container single-products">
        <div class="row">
            <div class="col-2">
                <img src="latest 10.png" width="300%" id="productImg">

                    <div class="small-img-row">
                        <div class="small-img-col">
                            <img src="pd_jeans low.png" width="90px" class="small-img">
                        </div>
                        <div class="small-img-col">
                            <img src="pd_jeans.png" width="90px" class="small-img">
                        </div>
                        <div class="small-img-col">
                            <img src="pd_jeans1.png" width="90px" class="small-img">
                        </div>
                        <div class="small-img-col">
                            <img src="pd_jeansback.png" width="90px" class="small-img">
                        </div>
                    </div>
