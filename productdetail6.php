...
<body>
    ...
    <div class="small-container single-products">
        <div class="row">
            <div class="col-2">
                <img src="latest 2nd.png" width="300%" id="productImg">

                    <div class="small-img-row">
                        <div class="small-img-col">
                            <img src="jogger pd side.png" width="90px" class="small-img">
                        </div>
                        <div class="small-img-col">
                            <img src="jogger pd full.png" width="90px" class="small-img">
                        </div>
                        <div class="small-img-col">
                            <img src="jogger pd back.png" width="90px" class="small-img">
                        </div>
                        <div class="small-img-col">
                            <img src="jogger pd fabric.png" width="90px" class="small-img">
                        </div>
                    </div>
