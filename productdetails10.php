...
<body>
    ...
    <div class="small-container single-products">
        <div class="row">
            <div class="col-2">
                <img src="latest 9.png" width="300%" id="productImg">

                    <div class="small-img-row">
                        <div class="small-img-col">
                            <img src="pd_chaapal.png" width="90px" class="small-img">
                        </div>
                        <div class="small-img-col">
                            <img src="pd_two chapal.png" width="90px" class="small-img">
                        </div>
                        <div class="small-img-col">
                            <img src="pd_side chapal.png" width="90px" class="small-img">
                        </div>
                        <div class="small-img-col">
                            <img src="pd_chapal details.png" width="90px" class="small-img">
                        </div>
                    </div>
