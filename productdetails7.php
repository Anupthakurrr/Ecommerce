...
<body>
    ...
    <div class="small-container single-products">
        <div class="row">
            <div class="col-2">
                <img src="latest pro 4.png" width="300%" id="productImg">

                    <div class="small-img-row">
                        <div class="small-img-col">
                            <img src="pd_astronaut side.png" width="90px" class="small-img">
                        </div>
                        <div class="small-img-col">
                            <img src="pd_astronaut front.png" width="90px" class="small-img">
                        </div>
                        <div class="small-img-col">
                            <img src="pd_astronaut brand.png" width="90px" class="small-img">
                        </div>
                        <div class="small-img-col">
                            <img src="pd_astronaut fabric.png" width="90px" class="small-img">
                        </div>
                    </div>
