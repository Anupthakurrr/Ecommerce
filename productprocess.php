...
<script nomodule src="https://unpkg.com/ionicons@7.1.0/dist/ionicons/ionicons.js"></script>
     ...
     <div class="small-container"> 
        <div class="row">
            <div class="col-4">
                <a href="productdetails.php"><img src="p_details1.png"></a>
            ...
            <div class="col-4">
                <a href="productdetails2.php"><img src="product 3.png">
        ...
        <div class="row">
            ...
            <div class="col-4">
                <a href="productdetails5.php"><img src="latest.png"></a>
                <h4>Men's Grey Oversized T-shirt</h4>
                <div class="rating">
                    <i><ion-icon name="star-sharp"></ion-icon></i>
                    <i><ion-icon name="star-outline"></ion-icon></i>
                    <i><ion-icon name="star-outline"></ion-icon></i>
