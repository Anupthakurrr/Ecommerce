...
<body>
    ...
    <div class="small-container single-products">
        <div class="row">
            <div class="col-2">
                <img src="latest 5.png" width="300%" id="productImg">

                    <div class="small-img-row">
                        <div class="small-img-col">
                            <img src="pd_animebag.png" width="90px" class="small-img">
                        </div>
                        <div class="small-img-col">
                            <img src="pd_animebag2.png" width="90px" class="small-img">
                        </div>
                        <div class="small-img-col">
                            <img src="pd_anime logo.png" width="90px" class="small-img">
                        </div>
                        <div class="small-img-col">
                            <img src="pd_anime open.png" width="90px" class="small-img">
                        </div>
                    </div>
