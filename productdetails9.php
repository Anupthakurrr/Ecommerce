...
<body>
    ...
    <div class="small-container single-products">
        <div class="row">
            <div class="col-2">
                <img src="latest 7.png" width="300%" id="productImg">

                    <div class="small-img-row">
                        <div class="small-img-col">
                            <img src="pd_green.png" width="90px" class="small-img">
                        </div>
                        <div class="small-img-col">
                            <img src="pd_single green.png" width="90px" class="small-img">
                        </div>
                        <div class="small-img-col">
                            <img src="pd_green logo.png" width="90px" class="small-img">
                        </div>
                        <div class="small-img-col">
                            <img src="pd_green duo.png" width="90px" class="small-img">
                        </div>
                    </div>
